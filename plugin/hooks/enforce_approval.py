...
READONLY_COMMANDS = {"rg", "grep", "ls", "cat", "head", "tail", "wc", "file", "fd", "tree", "which", "echo", "pwd", "date", "env", "printenv"}

# Git subcommands that are read-only
GIT_READONLY_SUBCOMMANDS = {"status", "diff", "show", "log", "rev-parse", "grep", "branch", "remote", "tag", "describe", "shortlog", "stash", "ls-files", "ls-tree", "cat-file"}
...
BLOCKED_COMMANDS = {
    ...
    "touch", "mv", "cp", "rm", "mkdir", "rmdir", "chmod", "chown",
    "dd", "install", "ln", "mktemp",
    "perl", "ruby", "php",
    "curl", "wget",
    "docker", "kubectl",
    "make", "cmake",
